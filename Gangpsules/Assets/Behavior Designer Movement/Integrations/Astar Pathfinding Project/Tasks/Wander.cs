...
namespace BehaviorDesigner.Runtime.Tasks.Movement.AstarPathfindingProject
{
    ...
    public class Wander : IAstarAIMovement
    {
        ...
        [Tooltip("The maximum length of time that the agent will wander. After that the task will return success")]
        public SharedFloat maxWanderDuration = 0;
        ...
        public override void OnStart()
        {
            ...
            endWanderTime = Time.time + maxWanderDuration.Value;
        }
